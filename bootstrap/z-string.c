...
static void z_string_init(Self *self)
{
 selfp->data = z_vector_new(CTX, sizeof(char));
 selfp->length = 0;
 selfp->token_it = 0;
 }
#line 43 "z-string.zco"
...
static uint8_t  z_string_get_next_byte(Self *self,ZVectorIter *it)
{
 ...
 if (z_vector_is_in_bound(selfp->data, it)) {
