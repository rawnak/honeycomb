...
#define assign z_string_iter_assign
...
ZCO_DEFINE_CLASS_TYPE(z_string_iter);
...
static void z_string_iter___delete(ZObject *self);
...
{
	ZCO_CREATE_CLASS(global, ZStringIter, z_string_iter, 1);
	ZCO_INHERIT_CLASS(ZObject, z_object, ZStringIter);
	ZCO_REGISTER_TYPE(z_string_iter);
	ZCO_OVERRIDE_VIRTUAL_METHOD(ZObject, z_object, z_string_iter, reset);
	ZCO_OVERRIDE_VIRTUAL_METHOD(ZObject, z_object, z_string_iter, class_destroy);
	ZCO_OVERRIDE_VIRTUAL_METHOD(ZObject, z_object, z_string_iter, __delete);
	ZCO_CREATE_METHOD_MAP(ZStringIter, z_string_iter);
...
{
	ZCO_INIT_START(ZStringIter, z_string_iter);
