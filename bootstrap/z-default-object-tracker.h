...
#define Z_DEFAULT_OBJECT_TRACKER(s) ((ZDefaultObjectTracker *) ((char *) (s) + (s)->_global->vtable_off_list[z_default_object_tracker_type_id]))
...
#line 26 "z-default-object-tracker.zco"
	ZObject *  (*__parent_create)(ZObjectTracker *self,int type_id);
#line 32 "z-default-object-tracker.zco"
	int  (*__parent_destroy)(ZObjectTracker *self,ZObject *target);
#line 38 "z-default-object-tracker.zco"
	void  (*__parent_garbage_collect)(ZObjectTracker *self);
};
